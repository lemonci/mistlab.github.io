...
BLOG_AUTHOR = "MIST Lab"  # (translatable)
BLOG_TITLE = "MIST Lab"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://mistlab.ca/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://mistlab.ca/"
BLOG_EMAIL = "info@mistlab.ca"
BLOG_DESCRIPTION = "Making Innovative Space Technologies"  # (translatable)
...
for p in people:
    if len([ x for x in PAGES if ('people' in x) ]): pass
    PAGES.append(("people/"+p+"/*.md","people/"+p,"story.tmpl"))
...
REDIRECTIONS = [("people/index.html", "/about/#people")]
...
SOCIAL_BUTTONS_CODE = """
		<div class="col-lg-3">
		   ...
		   <li>Follow us:</li>
                    <li class="tooltip-social facebook-link"><a href="https://www.facebook.com/mistlab.ca" data-toggle="tooltip" data-placement="top" title="Facebook"><i class="fa fa-facebook-square fa-2x"></i></a>
                    </li>
                    <li class="tooltip-social twitter-link"><a href="https://twitter.com/MIST_lab" data-toggle="tooltip" data-placement="top" title="Twitter"><i class="fa fa-twitter-square fa-2x"></i></a>
                    </li>
                    <li class="tooltip-social google-plus-link"><a href="https://google.com/+MistlabCa" data-toggle="tooltip" data-placement="top" title="Google+"><i class="fa fa-google-plus-square fa-2x"></i></a>
                    </li>
                  </ul>
		</div>
"""
...
# Deploy commands
DEPLOY_COMMANDS = { u'default': [u'rsync -av --no-p --no-o --no-g --delete --omit-dir-times output/ web.soccerlab.polymtl.ca:/var/www-mist/html']}
